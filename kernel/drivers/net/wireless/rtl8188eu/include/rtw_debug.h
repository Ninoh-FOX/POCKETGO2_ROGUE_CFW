...
#define DEBUG_LEVEL	(_drv_err_)
	...
	int proc_set_cbw40_enable(struct file *file, const char __user *buf,
				  size_t size, loff_t *ppos);
	int proc_get_ampdu_enable(struct seq_file *m, void *v);
	int proc_set_ampdu_enable(struct file *file, const char __user *buf,
				  size_t size, loff_t *ppos);
	int proc_get_rx_stbc(struct seq_file *m, void *v);
	int proc_set_rx_stbc(struct file *file, const char __user *buf,
			     size_t size, loff_t *ppos);
	...
	int proc_set_btcoex_dbg(struct file *file, const char __user *buf,
				size_t size, loff_t *ppos);
